...
class SecurityAndComplianceCenterApiV3(BaseService):
    ...
    def create_profile_attachment(
        ...
        instance_id: str,
        profile_id: str,
        new_attachments: List['ProfileAttachmentBase'],
        *,
        ...
        **kwargs,
        ...
        :param List[ProfileAttachmentBase] new_attachments: The Prototype to create
               a profile attachment.
        :param str new_profile_id: (optional) The profile ID to target against.
        :param str account_id: (optional) The user account ID.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        ...
        if new_attachments is None:
            raise ValueError('new_attachments must be provided')
        new_attachments = [convert_model(x) for x in new_attachments]
        headers = {}
        sdk_headers = get_sdk_headers(
            service_name=self.DEFAULT_SERVICE_NAME,
            service_version='V3',
    ...
    def replace_profile_attachment(
        ...
        status: str,
        *,
        data_selection_range: Optional['DateRange'] = None,
        account_id: Optional[str] = None,
        **kwargs,
    ) -> DetailedResponse:
        """
        ...
        :param DateRange data_selection_range: (optional) Date range.
        :param str account_id: (optional) The user account ID.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `ProfileAttachment` object
        ...
        if notifications is None:
            raise ValueError('notifications must be provided')
        if schedule is None:
        ...
        if data_selection_range is not None:
            data_selection_range = convert_model(data_selection_range)
        headers = {}
        sdk_headers = get_sdk_headers(
            service_name=self.DEFAULT_SERVICE_NAME,
            service_version='V3',
    ...
    def create_control_library(
        ...
        **kwargs,
        ...
        several specifications and assessments that are mapped to it. A specification is a
        defined requirement that is specific to a component. An assessment, or several,
        ...
        sdk_headers = get_sdk_headers(
            service_name=self.DEFAULT_SERVICE_NAME,
            service_version='V3',
            operation_id='create_control_library',
        )
        headers.update(sdk_headers)
    ...
    def replace_custom_control_library(
        ...
        **kwargs,
        ...
        :param str instance_id: The ID of the Security and Compliance Center
               instance.
        :param str control_library_id: The control library ID.
        :param str control_library_name: The name of the control library.
        :param str control_library_description: Details of the control library.
        :param str control_library_type: Details that the control library is a user
               made(custom) or Security Compliance Center(predefined).
    ...
    def create_profile(
        ...
        **kwargs,
        ...
        :param str profile_version: The version of the profile.
        ...
        if profile_version is None:
            raise ValueError('profile_version must be provided')
        if controls is None:
            raise ValueError('controls must be provided')
    ...
    def list_profiles(
        ...
        **kwargs,
        ...
        that are curated based on industry standards. Or you can choose to create one that
        is specific to your usecase by using an existing library as a starting point. For
    ...
    def replace_profile(
        ...
        new_controls: List['ProfileControls'],
        new_default_parameters: List['DefaultParameters'],
        *,
        new_id: Optional[str] = None,
        new_profile_name: Optional[str] = None,
        new_instance_id: Optional[str] = None,
        new_hierarchy_enabled: Optional[bool] = None,
        new_profile_description: Optional[str] = None,
        new_profile_version: Optional[str] = None,
        new_version_group_label: Optional[str] = None,
        new_latest: Optional[bool] = None,
        new_created_by: Optional[str] = None,
        new_created_on: Optional[datetime] = None,
        new_updated_by: Optional[str] = None,
        new_updated_on: Optional[datetime] = None,
        new_controls_count: Optional[int] = None,
        new_attachments_count: Optional[int] = None,
        account_id: Optional[str] = None,
        **kwargs,
    ) -> DetailedResponse:
        """
        ...
        :param str instance_id: The ID of the Security and Compliance Center
               instance.
        :param str profile_id: The profile ID.
        :param str new_profile_type: The type of profile, either predefined or
               custom.
        :param List[ProfileControls] new_controls: The list of controls.
        :param List[DefaultParameters] new_default_parameters: The default
               parameters of the profile.
        :param str new_id: (optional) The ID of the profile.
        :param str new_profile_name: (optional) The name of the profile.
        :param str new_instance_id: (optional) The ID of the Security and
               Compliance Center instance who owns the profile.
        :param bool new_hierarchy_enabled: (optional) Determines if the profile can
               be set to a hierarchy.
        :param str new_profile_description: (optional) A description of what the
               profile should represent.
        :param str new_profile_version: (optional) The version of the profile.
        :param str new_version_group_label: (optional) The unique identifier of the
               revision.
        :param bool new_latest: (optional) Determines if the profile is up to date
               with the latest revisions.
        :param str new_created_by: (optional) User who created the profile.
        :param datetime new_created_on: (optional) The date when the profile was
               created, in date-time format.
        :param str new_updated_by: (optional) User who made the latest changes to
               the profile.
        :param datetime new_updated_on: (optional) The date when the profile was
               last updated, in date-time format.
        :param int new_controls_count: (optional) The number of controls contained
               in the profile.
        :param int new_attachments_count: (optional) The number of attachments
        ...
        if not profile_id:
            raise ValueError('profile_id must be provided')
        if new_profile_type is None:
            raise ValueError('new_profile_type must be provided')
        if new_controls is None:
            raise ValueError('new_controls must be provided')
        if new_default_parameters is None:
            raise ValueError('new_default_parameters must be provided')
        new_controls = [convert_model(x) for x in new_controls]
        new_default_parameters = [convert_model(x) for x in new_default_parameters]
        if new_created_on is not None:
            new_created_on = datetime_to_string(new_created_on)
        if new_updated_on is not None:
            new_updated_on = datetime_to_string(new_updated_on)
        headers = {}
        sdk_headers = get_sdk_headers(
            service_name=self.DEFAULT_SERVICE_NAME,
            service_version='V3',
        ...
        data = {
            ...
            'default_parameters': new_default_parameters,
            'id': new_id,
            'profile_name': new_profile_name,
            'instance_id': new_instance_id,
            'hierarchy_enabled': new_hierarchy_enabled,
            'profile_description': new_profile_description,
            'profile_version': new_profile_version,
            'version_group_label': new_version_group_label,
            'latest': new_latest,
            ...
            'attachments_count': new_attachments_count,
        }
        data = {k: v for (k, v) in data.items() if v is not None}
        data = json.dumps(data)
        headers['content-type'] = 'application/json'
    ...
    def compare_profiles(
        ...
        **kwargs,
        ...
        :param str instance_id: The ID of the Security and Compliance Center
               instance.
        :param str profile_id: The profile ID to compare.
        :param str account_id: (optional) The user account ID.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
    ...
    def list_reports(
        ...
        *,
        ...
        report_profile_id: Optional[str] = None,
        ...
        **kwargs,
        ...
        :param str instance_id: The ID of the Security and Compliance Center
               instance.
        :param str report_attachment_id: (optional) The ID of the attachment.
        :param str group_id: (optional) The report group ID.
        :param str report_profile_id: (optional) The ID of the profile.
    ...
    def get_report_rule(
        ...
        **kwargs,
        ...
        :param str instance_id: The ID of the Security and Compliance Center
               instance.
        :param str report_id: The ID of the scan that is associated with a report.
        :param str rule_id: The ID of the rule within a report.
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
...
class GetLatestReportsEnums:
    """
    Enums for get_latest_reports parameters.
    """
...
class ListScanReportsEnums:
    """
    Enums for list_scan_reports parameters.
    """
...
class AdditionalTargetAttribute:
    ...
    :param object value: (optional) The value can be of any type.
    """
...
class ControlChanges:
    ...
    :param List[ProfileControls] added: A list of controls that were added.
    :param List[ProfileControls] removed: A list of controls that were removed.
    ...
    def __init__(
        self,
        added: List['ProfileControls'],
        removed: List['ProfileControls'],
...
class ControlChangesUpdated:
    ...
    :param ProfileControls current: (optional) The control details for a profile.
    :param ProfileControls latest: (optional) The control details for a profile.
    """

    def __init__(
        self,
        *,
        current: Optional['ProfileControls'] = None,
        latest: Optional['ProfileControls'] = None,
    ) -> None:
        """
        Initialize a ControlChangesUpdated object.

        :param ProfileControls current: (optional) The control details for a
               profile.
        :param ProfileControls latest: (optional) The control details for a
               profile.
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'ControlChangesUpdated':
        ...
        if (current := _dict.get('current')) is not None:
            args['current'] = ProfileControls.from_dict(current)
        if (latest := _dict.get('latest')) is not None:
            args['latest'] = ProfileControls.from_dict(latest)
        return cls(**args)
...
class EvaluationProperty:
    ...
    :param object expected_value: (optional) The value can be of any type.
    :param object found_value: (optional) The value can be of any type.
    """
...
class MultiCloudScopePayload:
    ...
    def __init__(
        ...
        """
        msg = "Cannot instantiate base class. Instead, instantiate one of the defined subclasses: {0}".format(
            ", ".join(['MultiCloudScopePayloadById', 'MultiCloudScopePayloadByProperties'])
        )
        raise Exception(msg)
...
class Parameter:
    ...
    :param str parameter_display_name: (optional) The parameter display name.
    :param str parameter_type: (optional) The parameter type.
    :param object parameter_value: (optional) The value can be of any type.
    """
...
class Profile:
    ...
    :param int attachments_count: (optional) The number of attachments associated
          with the profile.
    :param List[ProfileControls] controls: The list of controls.
    ...
    def from_dict(cls, _dict: Dict) -> 'Profile':
        ...
        if (controls := _dict.get('controls')) is not None:
            args['controls'] = [ProfileControls.from_dict(v) for v in controls]
        else:
...
class ProfileAttachment:
    ...
    def __init__(
        ...
        *,
        ...
        self.scope = scope
        self.status = status
        self.data_selection_range = data_selection_range
        self.account_id = account_id
        self.created_by = created_by
        self.created_on = created_on
        self.id = id
    ...
    def from_dict(cls, _dict: Dict) -> 'ProfileAttachment':
        ...
        if (data_selection_range := _dict.get('data_selection_range')) is not None:
            args['data_selection_range'] = DateRange.from_dict(data_selection_range)
        if (account_id := _dict.get('account_id')) is not None:
            args['account_id'] = account_id
        if (created_by := _dict.get('created_by')) is not None:
            args['created_by'] = created_by
    ...
    def to_dict(self) -> Dict:
        ...
        if hasattr(self, 'status') and self.status is not None:
            _dict['status'] = self.status
        if hasattr(self, 'data_selection_range') and self.data_selection_range is not None:
            if isinstance(self.data_selection_range, dict):
                _dict['data_selection_range'] = self.data_selection_range
            else:
                _dict['data_selection_range'] = self.data_selection_range.to_dict()
        if hasattr(self, 'account_id') and self.account_id is not None:
            _dict['account_id'] = self.account_id
        if hasattr(self, 'created_by') and self.created_by is not None:
            _dict['created_by'] = self.created_by
...
class ProfileCollection:
    ...
    :param PageHRefFirst first: (optional) A page reference.
    :param PageHRefNext next: (optional) A page reference.
    :param List[Profile] profiles: A list of profiles associated with the scope.
    """
    ...
    def __init__(
        ...
        *,
        ...
        :param int total_count: The total number of resources that are in the
               collection.
        :param List[Profile] profiles: A list of profiles associated with the
               scope.
        :param PageHRefFirst first: (optional) A page reference.
        :param PageHRefNext next: (optional) A page reference.
        """
...
class ProfileControls:
    ...
    def from_dict(cls, _dict: Dict) -> 'ProfileControls':
        ...
        if (control_specifications := _dict.get('control_specifications')) is not None:
            ...
            raise ValueError('Required property \'control_specifications\' not present in ProfileControls JSON')
        return cls(**args)
...
class ReportScope:
    ...
    :param str environment: (optional) The cloud provider that the scope is
          targeting.
    """
...
class ScopeProperty:
    ...
    def __init__(
        ...
        """
        msg = "Cannot instantiate base class. Instead, instantiate one of the defined subclasses: {0}".format(
            ", ".join(['ScopePropertyScopeAny', 'ScopePropertyScopeType', 'ScopePropertyScopeId', 'ScopePropertyExclusions'])
        )
        raise Exception(msg)
...
class MultiCloudScopePayloadById(MultiCloudScopePayload):
    """
    The payload to reference a previously made scope object.

    :param str id: (optional) The UUID of the scope made.
    """
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize a MultiCloudScopePayloadById object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'MultiCloudScopePayloadById':
        """Initialize a MultiCloudScopePayloadById object from a json dictionary."""
        args = {}
        if (id := _dict.get('id')) is not None:
            args['id'] = id
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this MultiCloudScopePayloadById object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'MultiCloudScopePayloadById') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'MultiCloudScopePayloadById') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other


class MultiCloudScopePayloadByProperties(MultiCloudScopePayload):
    """
    The payload to create a new Scope from a Profile Attachment.

    :param str description: (optional) The details of a newly created scope.
    ...
    def __init__(
        ...
        *,
        ...
        """
        Initialize a MultiCloudScopePayloadByProperties object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'MultiCloudScopePayloadByProperties':
        """Initialize a MultiCloudScopePayloadByProperties object from a json dictionary."""
        args = {}
        if (description := _dict.get('description')) is not None:
            args['description'] = description
        if (environment := _dict.get('environment')) is not None:
        ...
        if (properties := _dict.get('properties')) is not None:
            ...
            raise ValueError('Required property \'properties\' not present in MultiCloudScopePayloadByProperties JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this MultiCloudScopePayloadByProperties object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'MultiCloudScopePayloadByProperties') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'MultiCloudScopePayloadByProperties') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class ScopePropertyScopeAny(ScopeProperty):
    ...
    def __init__(
        ...
        """
        Initialize a ScopePropertyScopeAny object.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'ScopePropertyScopeAny':
        """Initialize a ScopePropertyScopeAny object from a json dictionary."""
        args = {}
        if (name := _dict.get('name')) is not None:
            args['name'] = name
        else:
            raise ValueError('Required property \'name\' not present in ScopePropertyScopeAny JSON')
        if (value := _dict.get('value')) is not None:
            args['value'] = value
        else:
            raise ValueError('Required property \'value\' not present in ScopePropertyScopeAny JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this ScopePropertyScopeAny object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'ScopePropertyScopeAny') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'ScopePropertyScopeAny') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class ScopePropertyScopeId(ScopeProperty):
    ...
    :param str value: The identifier for the scope_type specified.
    """
    ...
    def from_dict(cls, _dict: Dict) -> 'ScopePropertyScopeId':
        ...
        if (value := _dict.get('value')) is not None:
            ...
            raise ValueError('Required property \'value\' not present in ScopePropertyScopeId JSON')
        return cls(**args)
...
class ControlLibrariesPager:
    ...
    def get_next(self) -> List[dict]:
        """
        Returns the next page of results.
        :return: A List[dict], where each element is a dict that represents an instance of ControlLibrary.
        :rtype: List[dict]
        """
        if not self.has_next():
            raise StopIteration(message='No more results available')
...
class ProfilesPager:
    ...
    def get_next(self) -> List[dict]:
        """
        Returns the next page of results.
        :return: A List[dict], where each element is a dict that represents an instance of Profile.
        :rtype: List[dict]
        """
        if not self.has_next():
            raise StopIteration(message='No more results available')
...
class ReportsPager:
    ...
    def __init__(
        ...
        *,
        ...
        self._page_context = {'next': None}
        self._instance_id = instance_id
        self._report_attachment_id = report_attachment_id
    ...
    def get_next(self) -> List[dict]:
        ...
        result = self._client.list_reports(
            instance_id=self._instance_id,
            report_attachment_id=self._report_attachment_id,
            group_id=self._group_id,
            report_profile_id=self._report_profile_id,
            type=self._type,
            limit=self._limit,
            sort=self._sort,
            start=self._page_context.get('next'),
