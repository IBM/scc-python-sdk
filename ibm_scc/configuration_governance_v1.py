...
class ConfigurationGovernanceV1(BaseService):
    ...
    def create_rules(self,
        ...
        **kwargs
        ...
        [docs](/docs/security-compliance?topic=security-compliance-what-is-rule).
    ...
    def create_rule_attachments(self,
        rule_id: str,
        attachments: List['RuleAttachmentRequest'],
        *,
        transaction_id: str = None,
        **kwargs
    ) -> DetailedResponse:
        ...
        :param str rule_id: The UUID that uniquely identifies the rule.
        :param List[RuleAttachmentRequest] attachments:
        :param str transaction_id: (optional) The unique identifier that is used to
               trace an entire request. If you omit this field, the service generates and
               sends a transaction ID as a response header of the request. In the case of
               an error, the transaction ID is set in the `trace` field of the response
        ...
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `CreateRuleAttachmentsResponse` object
        """
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME,
                                      service_version='V1',
                                      operation_id='create_rule_attachments')
        headers.update(sdk_headers)
    ...
    def list_rule_attachments(self,
        rule_id: str,
        *,
        transaction_id: str = None,
        limit: int = None,
        ...
        **kwargs
        ...
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `RuleAttachmentList` object
        """
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME,
                                      service_version='V1',
                                      operation_id='list_rule_attachments')
        headers.update(sdk_headers)
    ...
    def get_rule_attachment(self,
        ...
        **kwargs
        ...
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `RuleAttachment` object
        """
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME,
                                      service_version='V1',
                                      operation_id='get_rule_attachment')
        headers.update(sdk_headers)
    ...
    def update_rule_attachment(self,
        rule_id: str,
        attachment_id: str,
        if_match: str,
        account_id: str,
        ...
        **kwargs
        ...
        :param dict headers: A `dict` containing the request headers
        :return: A `DetailedResponse` containing the result, headers and HTTP status code.
        :rtype: DetailedResponse with `dict` result representing a `TemplateAttachment` object
        """
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME,
                                      service_version='V1',
                                      operation_id='update_rule_attachment')
        headers.update(sdk_headers)
    ...
    def delete_rule_attachment(self,
        rule_id: str,
        attachment_id: str,
        *,
        transaction_id: str = None,
        **kwargs
        ...
        sdk_headers = get_sdk_headers(service_name=self.DEFAULT_SERVICE_NAME,
                                      service_version='V1',
                                      operation_id='delete_rule_attachment')
        headers.update(sdk_headers)
...
class CreateRuleAttachmentsResponse():
    """
    ...
    def __init__(self,
                 attachments: List['RuleAttachment']) -> None:
        """
        Initialize a CreateRuleAttachmentsResponse object.

        :param List[RuleAttachment] attachments:
        """
        self.attachments = attachments

    @classmethod
    def from_dict(cls, _dict: Dict) -> 'CreateRuleAttachmentsResponse':
        """Initialize a CreateRuleAttachmentsResponse object from a json dictionary."""
        args = {}
        if 'attachments' in _dict:
            args['attachments'] = [RuleAttachment.from_dict(x) for x in _dict.get('attachments')]
        else:
            raise ValueError('Required property \'attachments\' not present in CreateRuleAttachmentsResponse JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this CreateRuleAttachmentsResponse object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'CreateRuleAttachmentsResponse') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'CreateRuleAttachmentsResponse') -> bool:
...
class CreateRuleRequest():
    ...
    def __init__(self,
        ...
        :param RuleRequest rule: Properties that you can associate with a rule.
...
class CreateRuleResponse():
    ...
    properties are returned in the response. If the 'status_code' property indicates an
    error, the 'request_id', 'errors', and 'trace' fields are returned.
...
class Rule():
    """
    Properties associated with a rule, including both user-defined and server-populated
    properties.
...
class RuleAttachment():
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'RuleAttachment':
        ...
        if 'attachment_id' in _dict:
            ...
            raise ValueError('Required property \'attachment_id\' not present in RuleAttachment JSON')
        if 'rule_id' in _dict:
            args['rule_id'] = _dict.get('rule_id')
        else:
            raise ValueError('Required property \'rule_id\' not present in RuleAttachment JSON')
        if 'account_id' in _dict:
            args['account_id'] = _dict.get('account_id')
        else:
            raise ValueError('Required property \'account_id\' not present in RuleAttachment JSON')
        if 'included_scope' in _dict:
            args['included_scope'] = RuleScope.from_dict(_dict.get('included_scope'))
        else:
            raise ValueError('Required property \'included_scope\' not present in RuleAttachment JSON')
    ...
    def __str__(self) -> str:
        """Return a `str` version of this RuleAttachment object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'RuleAttachment') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'RuleAttachment') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other

class RuleAttachmentList():
    """
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'RuleAttachmentList':
        """Initialize a RuleAttachmentList object from a json dictionary."""
        args = {}
        if 'offset' in _dict:
            args['offset'] = _dict.get('offset')
        else:
            raise ValueError('Required property \'offset\' not present in RuleAttachmentList JSON')
        if 'limit' in _dict:
            args['limit'] = _dict.get('limit')
        else:
            raise ValueError('Required property \'limit\' not present in RuleAttachmentList JSON')
        if 'total_count' in _dict:
            args['total_count'] = _dict.get('total_count')
        else:
            raise ValueError('Required property \'total_count\' not present in RuleAttachmentList JSON')
        if 'first' in _dict:
            args['first'] = Link.from_dict(_dict.get('first'))
        else:
            raise ValueError('Required property \'first\' not present in RuleAttachmentList JSON')
        if 'last' in _dict:
            args['last'] = Link.from_dict(_dict.get('last'))
        else:
            raise ValueError('Required property \'last\' not present in RuleAttachmentList JSON')
        if 'attachments' in _dict:
            args['attachments'] = [RuleAttachment.from_dict(x) for x in _dict.get('attachments')]
        else:
            raise ValueError('Required property \'attachments\' not present in RuleAttachmentList JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this RuleAttachmentList object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'RuleAttachmentList') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'RuleAttachmentList') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other

class RuleAttachmentRequest():
    """
    The scopes to attach to a rule.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'RuleAttachmentRequest':
        """Initialize a RuleAttachmentRequest object from a json dictionary."""
        args = {}
        if 'account_id' in _dict:
            args['account_id'] = _dict.get('account_id')
        else:
            raise ValueError('Required property \'account_id\' not present in RuleAttachmentRequest JSON')
        if 'included_scope' in _dict:
            args['included_scope'] = RuleScope.from_dict(_dict.get('included_scope'))
        else:
            raise ValueError('Required property \'included_scope\' not present in RuleAttachmentRequest JSON')
        if 'excluded_scopes' in _dict:
            args['excluded_scopes'] = [RuleScope.from_dict(x) for x in _dict.get('excluded_scopes')]
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this RuleAttachmentRequest object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'RuleAttachmentRequest') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'RuleAttachmentRequest') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class RuleSingleProperty():
    ...
    :attr str operator: The way in which the `property` field is compared to its
          ...
          [docs](/docs/security-compliance?topic=security-compliance-what-is-rule#rule-operators).
...
class TargetResource():
    """
    The properties that describe the resource that you want to target with the rule or
    template.

    :attr str service_name: The programmatic name of the IBM Cloud service that you
          want to target with the rule or template.
    :attr str resource_kind: The type of resource that you want to target.
    :attr List[TargetResourceAdditionalTargetAttributesItem]
          additional_target_attributes: (optional) An extra qualifier for the resource
          kind. When you include additional attributes, only the resources that match the
    ...
    def __init__(self,
                 ...
                 resource_kind: str,
                 *,
                 additional_target_attributes: List['TargetResourceAdditionalTargetAttributesItem'] = None) -> None:
        """
        Initialize a TargetResource object.

        :param str service_name: The programmatic name of the IBM Cloud service
               that you want to target with the rule or template.
        :param str resource_kind: The type of resource that you want to target.
        :param List[TargetResourceAdditionalTargetAttributesItem]
               additional_target_attributes: (optional) An extra qualifier for the
               resource kind. When you include additional attributes, only the resources
               that match the definition are included in the rule or template.
        """
    ...
    def from_dict(cls, _dict: Dict) -> 'TargetResource':
        ...
        if 'additional_target_attributes' in _dict:
            args['additional_target_attributes'] = [TargetResourceAdditionalTargetAttributesItem.from_dict(x) for x in _dict.get('additional_target_attributes')]
        return cls(**args)
...
class TargetResourceAdditionalTargetAttributesItem():
    """
    ...
    def __init__(self,
        ...
        :param str name: The name of the additional attribute that you want to use
               to further qualify the target.
               Options differ depending on the service or resource that you are targeting
               with a rule or template. For more information, refer to the service
               documentation.
        :param str value: The value that you want to apply to `name` field.
               Options differ depending on the rule or template that you configure. For
               more information, refer to the service documentation.
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'TargetResourceAdditionalTargetAttributesItem':
        """Initialize a TargetResourceAdditionalTargetAttributesItem object from a json dictionary."""
        args = {}
        if 'name' in _dict:
            args['name'] = _dict.get('name')
        else:
            raise ValueError('Required property \'name\' not present in TargetResourceAdditionalTargetAttributesItem JSON')
        if 'value' in _dict:
            args['value'] = _dict.get('value')
        else:
            raise ValueError('Required property \'value\' not present in TargetResourceAdditionalTargetAttributesItem JSON')
        if 'operator' in _dict:
            args['operator'] = _dict.get('operator')
        else:
            raise ValueError('Required property \'operator\' not present in TargetResourceAdditionalTargetAttributesItem JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this TargetResourceAdditionalTargetAttributesItem object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'TargetResourceAdditionalTargetAttributesItem') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'TargetResourceAdditionalTargetAttributesItem') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class TemplateAttachment():
    ...
    :attr str attachment_id: The UUID that uniquely identifies the attachment.
    :attr str template_id: The UUID that uniquely identifies the template.
    :attr str account_id: Your IBM Cloud account ID.
    :attr TemplateScope included_scope: The extent at which the template can be
          attached across your accounts.
    :attr List[TemplateScope] excluded_scopes: (optional)
    """
    ...
    def __init__(self,
                 ...
                 *,
                 excluded_scopes: List['TemplateScope'] = None) -> None:
        """
        Initialize a TemplateAttachment object.

        :param str attachment_id: The UUID that uniquely identifies the attachment.
        :param str template_id: The UUID that uniquely identifies the template.
        :param str account_id: Your IBM Cloud account ID.
        :param TemplateScope included_scope: The extent at which the template can
               be attached across your accounts.
        :param List[TemplateScope] excluded_scopes: (optional)
        """
        self.attachment_id = attachment_id
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'TemplateAttachment':
        """Initialize a TemplateAttachment object from a json dictionary."""
        args = {}
        if 'attachment_id' in _dict:
            args['attachment_id'] = _dict.get('attachment_id')
        else:
            raise ValueError('Required property \'attachment_id\' not present in TemplateAttachment JSON')
        if 'template_id' in _dict:
            args['template_id'] = _dict.get('template_id')
        else:
            raise ValueError('Required property \'template_id\' not present in TemplateAttachment JSON')
        if 'account_id' in _dict:
            args['account_id'] = _dict.get('account_id')
        else:
            raise ValueError('Required property \'account_id\' not present in TemplateAttachment JSON')
        if 'included_scope' in _dict:
            args['included_scope'] = TemplateScope.from_dict(_dict.get('included_scope'))
        else:
            raise ValueError('Required property \'included_scope\' not present in TemplateAttachment JSON')
        if 'excluded_scopes' in _dict:
            args['excluded_scopes'] = [TemplateScope.from_dict(x) for x in _dict.get('excluded_scopes')]
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this TemplateAttachment object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'TemplateAttachment') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'TemplateAttachment') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
...
class TemplateScope():
    ...
    :attr str note: (optional) A short description or alias to assign to the scope.
    :attr str scope_id: The ID of the scope, such as an enterprise, account, or
          account group, where you want to apply the customized defaults that are
          associated with a template.
    :attr str scope_type: The type of scope.
    """
    ...
    def __init__(self,
        ...
        :param str scope_id: The ID of the scope, such as an enterprise, account,
               or account group, where you want to apply the customized defaults that are
               associated with a template.
        :param str scope_type: The type of scope.
        :param str note: (optional) A short description or alias to assign to the
               scope.
        """
        self.note = note
    ...
    @classmethod
    def from_dict(cls, _dict: Dict) -> 'TemplateScope':
        ...
        if 'scope_id' in _dict:
            ...
            raise ValueError('Required property \'scope_id\' not present in TemplateScope JSON')
        if 'scope_type' in _dict:
            args['scope_type'] = _dict.get('scope_type')
        else:
            raise ValueError('Required property \'scope_type\' not present in TemplateScope JSON')
        return cls(**args)
    ...
    def __str__(self) -> str:
        """Return a `str` version of this TemplateScope object."""
        return json.dumps(self.to_dict(), indent=2)

    def __eq__(self, other: 'TemplateScope') -> bool:
        """Return `true` when self and other are equal, false otherwise."""
        if not isinstance(other, self.__class__):
            return False
        return self.__dict__ == other.__dict__

    def __ne__(self, other: 'TemplateScope') -> bool:
        """Return `true` when self and other are not equal, false otherwise."""
        return not self == other
