...
# IBM Cloud Security & Compliance Center Python SDK Version 1.0.0
...
--- | --- | ---
[Findings](https://cloud.ibm.com/apidocs/findings) | findings_v1 | FindingsV1
...
```bash
pip install --upgrade "ibm-scc>=1.0.0"
```

or

```bash
easy_install --upgrade "ibm-scc>=1.0.0"
```
